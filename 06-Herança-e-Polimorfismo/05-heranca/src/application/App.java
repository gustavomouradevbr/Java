...
/**
 * Demonstra casts entre tipos e uso de `instanceof` para segurança de runtime.
 */
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Account acc1 = bacc; // atribuição por herança
        Account acc2 = new BusinessAccount(1003, "Bob", 0.0, 200.0);
        Account acc3 = new SavingsAccount(1004, "Anna", 0.0, 0.01);

        BusinessAccount acc4 = (BusinessAccount) acc2; // cast seguro, pois acc2 é BusinessAccount
        acc4.loan(100.0);
